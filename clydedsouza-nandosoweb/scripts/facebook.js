...
var loggedOutCoupons = "<div class='row'>";
loggedOutCoupons += "<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>";
loggedOutCoupons += "<div class='coupon-item'><h3>To reveal your coupons, log in using your facebook id above</h3></div>";
loggedOutCoupons += "</div>";
loggedOutCoupons += "</div>";
var accessCard = "";
